...
extern sl_iostream_t *sl_iostream_usart_handle;
extern sl_iostream_uart_t *sl_iostream_uart_usart_handle;
extern sl_iostream_instance_info_t sl_iostream_instance_usart_info;
