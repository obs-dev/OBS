#ifndef SL_EMLIB_GPIO_INIT_GPIO_CONFIG_H
#define SL_EMLIB_GPIO_INIT_GPIO_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_GPIO_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_GPIO_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_GPIO_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_GPIO_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_GPIO
// $[GPIO_SL_EMLIB_GPIO_INIT_GPIO]
#define SL_EMLIB_GPIO_INIT_GPIO_PORT             gpioPortA
#define SL_EMLIB_GPIO_INIT_GPIO_PIN              7
// [GPIO_SL_EMLIB_GPIO_INIT_GPIO]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_GPIO_CONFIG_H
