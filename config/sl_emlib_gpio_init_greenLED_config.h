#ifndef SL_EMLIB_GPIO_INIT_GREENLED_CONFIG_H
#define SL_EMLIB_GPIO_INIT_GREENLED_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_GREENLED_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_GREENLED_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_GREENLED_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_GREENLED_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_GREENLED
// $[GPIO_SL_EMLIB_GPIO_INIT_GREENLED]
#define SL_EMLIB_GPIO_INIT_GREENLED_PORT         gpioPortA
#define SL_EMLIB_GPIO_INIT_GREENLED_PIN          0
// [GPIO_SL_EMLIB_GPIO_INIT_GREENLED]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_GREENLED_CONFIG_H
