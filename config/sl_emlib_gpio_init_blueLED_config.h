#ifndef SL_EMLIB_GPIO_INIT_BLUELED_CONFIG_H
#define SL_EMLIB_GPIO_INIT_BLUELED_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_BLUELED_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_BLUELED_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_BLUELED_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_BLUELED_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_BLUELED
// $[GPIO_SL_EMLIB_GPIO_INIT_BLUELED]
#define SL_EMLIB_GPIO_INIT_BLUELED_PORT          gpioPortA
#define SL_EMLIB_GPIO_INIT_BLUELED_PIN           8
// [GPIO_SL_EMLIB_GPIO_INIT_BLUELED]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_BLUELED_CONFIG_H
